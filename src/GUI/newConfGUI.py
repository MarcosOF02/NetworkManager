...
class Ui_newConfGUI(object):
    def setupUi(self, newConfGUI):
        ...
        self.label_21 = QtWidgets.QLabel(parent=newConfGUI)
        self.label_21.setStyleSheet("font: 14pt \"Ubuntu\";")
        self.label_21.setObjectName("label_21")
        self.verticalLayout_3.addWidget(self.label_21)
        self.lineEdit_Divider_2 = QtWidgets.QLineEdit(parent=newConfGUI)
        self.lineEdit_Divider_2.setObjectName("lineEdit_Divider_2")
        self.verticalLayout_3.addWidget(self.lineEdit_Divider_2)
    ...
    def retranslateUi(self, newConfGUI):
        ...
        self.label_21.setText(_translate("newConfGUI", "Name Divider:"))
