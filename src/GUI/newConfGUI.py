...
class Ui_newConfGUI(object):
    def setupUi(self, newConfGUI):
        ...
        self.label_6 = QtWidgets.QLabel(parent=newConfGUI)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_3.addWidget(self.label_6)
        self.lineEdit = QtWidgets.QLineEdit(parent=newConfGUI)
    ...
    def retranslateUi(self, newConfGUI):
        ...
        self.label_6.setText(_translate("newConfGUI", "DatasetBuilderConf (Ruta relativa):"))
        self.lineEdit.setText(_translate("newConfGUI", "../cfg/datasetBuilderConfExample.cfg"))
